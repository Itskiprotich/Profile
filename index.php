        ...
        <div class="culmn">
            <nav class="navbar navbar-default bootsnav navbar-fixed black no-background">
                ...
                <div class="side">
                    ...
                    <div class="widget">
                        <h6 class="title">Kiprotich Japheth Portfolio</h6>
                        ...
                        <div class="main_home">
                            ...
                            <div class="col-sm-6">
                                <div class="home_text text-left">
                                    <h4>Hello Friends, I’m a freelancer</h4>
                                    <h1 class="text-black">Android App Developer</h1>
                                </div>

                                <div class="home_btns m-top-40 text-center">
                                    <a href="#about" class="btn btn-primary m-top-20">About me</a>
                                </div>
                        ...
                        <div class="main_about">
                            <div class="col-md-5 col-md-offset-1">
                                <div class="about_content">
                                    ...
                                    <div class="about_content_text">
                                        <p>Kiprotich Japheth is a focused computer scientist with a passion of programming.</p>
                                        ...
                                        <div class="about_content_item m-top-30">
                                            ...
                                            <ul>
                                                <li><a href=""><i class="fa fa-chevron-right"></i>School of App Development</a></li>
                                            </ul>
                                        </div>
                                        <div class="about_content_item m-top-20">
                                            <h6><i class="fa fa-briefcase"></i> Work Experiences</h6>
                                            <ul>
                                                <li><i class="fa fa-chevron-right"></i>Crime Scene App | 2017</li>
                                                <li><i class="fa fa-chevron-right"></i>Freelancer Africa3Dhub | 2018</li>
                            ...
                            <div class="col-md-5 col-md-offset-1 sm-m-top-50">
                                <div class="head_title text-right">
                                    <h5><span class="divider"></span>My name is Kiprotich Japheth</h5>
                                </div>
                            ...
                            <div class="col-md-5">
                                <div class="portfolio_item">
                                    ...
                                    <div class="row m-top-60">
                                        <div class="col-sm-6">
                                            <div class="portf_item_text branding">
                                                <a href="assets/images/about-img1.jpg" class="popup-img"><img src="assets/images/about-img1.jpg" alt="" /></a>
                            ...
                            <div class="col-md-6 col-md-offset-1 sm-m-top-50">
                                ...
                                <div class="may_client m-top-50">
                                    ...
                                    <div class="client_brand m-top-60 text-right">
                                        <ul class="list-inline">
                                            <li><img src="assets/images/about-img1.jpg"  height="61px" width="76px" alt="" /></li>
                                            <li><img src="assets/images/about-img1.jpg"  height="80px" width="54px" alt="" /></li>
                                            <li><img src="assets/images/about-img1.jpg"  height="87px" width="43px" alt="" /></li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- End off col-md-6  -->
                                ...
                                <form class="m-top-50">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control">
                                            ...
                                            <option>Mpesa Integration</option>
                            ...
                            <div class="col-md-6 col-md-offset-1 sm-m-top-50">
                                <div class="contact_content">
                                    ...
                                    <div class="contact_content_text">
                                        ...
                                        <ul class="m-top-50">
                                            <li>Address 102, Mosoriot<br />
                                                Kenya.</li>
                                            <li class="phone">+254724743788</li>
                                            <li class="info">keeprawteachjapheth@gmail.com</li>
                                        </ul>

                                        <div class="author_text text-right">
                                            <h5>Regards!</h5>
                                            <h1>Kiprotich Japheth</h1>
                                            <h6>Android App Developer</h6>
                                        </div>
                                        <div class="copyright text-right m-top-80">
                                            <p class="wow fadeInRight">Made with <i class="fa fa-heart"></i> by <a href="">Kiprotich Japheth</a>2019. All Rights Reserved</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
